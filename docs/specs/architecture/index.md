...
| 2026-09-15 | Project Layout gains a `site/` top-level directory for the static landing site at `ob.fx.gd` (planned). It is a standalone package outside the root lint/typecheck/coverage scope and is never copied into the image; its behavior is owned by the [Landing Site spec](../landing-site/index.md). | [Change 0016](../../changes/0016-landing-site.md) |
